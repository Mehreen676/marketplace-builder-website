...
// import { sanityFetch } from "@/sanity/lib/fatch"
...
//             <div className=" border p-4 rounded-lg shadow-sm flex flex-raw items-center" key={product._id}><Image src={product.image} alt={product.image} className="w-60" height={500} width={500}/>
//             <h2 className="text-xl font-bold text-center">{product.name
// }</h2>
//{/* <p className="text-center">{product.description}</p>
//{/* <p className="text-center">{product.price}</p></div>
         // ))}
